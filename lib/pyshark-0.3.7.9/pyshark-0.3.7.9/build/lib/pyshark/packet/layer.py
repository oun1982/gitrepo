...
class Layer(Pickleable):
    ...
    def get_field(self, name):
        ...
        for field_name, field in list(self._all_fields.items()):
...
class JsonLayer(Layer):
    ...
    def _is_fake_field(self, name):
        ...
        for name, field in list(self._all_fields.items()):
    ...
    def _make_wrapped_field(self, name, field, is_fake=False, full_name=None):
        ...
        if is_fake:
            ...
            field = {key: value for key, value in list(self._all_fields.items())
